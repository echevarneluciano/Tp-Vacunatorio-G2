...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-06-2021 a las 01:25:23
...
INSERT INTO `laboral` (`idTrabajo`, `nombre`, `estado`) VALUES
(1, 'Industria textil', 0),
(2, 'Tecnico informatico', 0),
(3, 'Comercio almacen', 0),
(4, 'Trabajo informal', 0);
...
INSERT INTO `persona` (`dni`, `nombre`, `apellido`, `fechaNac`, `localidad`, `direccion`, `email`, `telefono`, `idPersona`, `idPatologia`, `idTrabajo`, `estado`) VALUES
(3322333, 'Luciano', 'Echevarne', '1987-05-03', 'San Luis', 'B Cerro de la cruz', 'lalal@lalo.com', 443322, 1, 2, 2, 0),
(32222203, 'Lucas', 'Reinoso', '1990-05-04', 'Anchorena', 'Villa de Anchorena s/n', 'ancho@rena.com', 4433221, 2, 3, 3, 0);
